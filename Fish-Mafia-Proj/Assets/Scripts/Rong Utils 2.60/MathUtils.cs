...
public static class MathUtils
{
    ...
    /// <summary>
    /// Returns true if value lies between min and max.
    /// The boundary values themselves are NOT included.
    /// </summary>
    ...
    /// <summary>
    /// Returns true if value lies between min and max, including both boundaries.
    /// </summary>
    public static bool IsBetweenInclusive(float value, float min, float max)
    {
        return value >= min && value <= max;
    }
}
